    ...
    <div className={`relative ${className}`}>
      <div
        className='absolute -inset-3 bg-orange-500/15 dark:bg-transparent dark:bg-gradient-to-b 
          ...
          before:bg-no-repeat before:[background-image:radial-gradient(circle_at_center,theme(colors.orange.500/.56)_1.5px,transparent_1.5px),radial-gradient(circle_at_center,theme(colors.orange.500/.56)_1.5px,transparent_1.5px)] 
          ...
          after:bg-no-repeat after:[background-image:radial-gradient(circle_at_center,theme(colors.orange.500/.56)_1.5px,transparent_1.5px),radial-gradient(circle_at_center,theme(colors.orange.500/.56)_1.5px,transparent_1.5px)] 
